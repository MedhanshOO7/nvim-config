...
_(Optional: Install **JetBrains Mono Nerd Font** and **Windows Terminal**: `winget install Microsoft.WindowsTerminal NerdFonts.JetBrainsMono -e`)_
...
| **`<leader>un`** | **Notification History**                   | noice.nvim          |
